...
<div style="background-color:graytext; clear:both;
    ...
    padding:0px"><h3 style="text-align: center">Welcome <%=uname%></h3><p id="q1"><a href="Logout.jsp">Sign Out</a></p><p id="q2"><a href="passchange.jsp" name="per">Change Password</a></p></div><div style="position: absolute;top:100px;background-color: lightgray;height:350px;width:428px;margin-right: 10px;margin-left: 15px">
        <a href="stu_atten.jsp"><p style="text-align: center;font-family: algerian;">Attendance</p>
        ...
        <a href="stu_atten.jsp"><p style="text-align: center;font-family: algerian;">Time Table</p>
