 ...
 if(uname == null) {
      ...
      %>
        <div style="position: absolute;width:100%;background-color: graytext;text-align: center;padding: 0px;margin: 0px">
           ...
           <a href="stufill_patten.jsp"><p id="id3">YESTERDAY</p></a>
           <a href="stu_smonth.jsp"><p id="id2">MONTHLY / SEM</p></a>
        
            
           
</div>
        <div style="position: absolute;width: 50%;top: 200px;left: 652px;">
            
             <a href="stu_yfill.jsp"><input type="button" value="EDIT"></input></a>
