...
session.setAttribute("sub", usub);
 ...
 if(uname == null) {
   ...
   // Statement stmt = con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_READ_ONLY);
            ...
            out.print("<form action='stu_insert' name='ntfill'>");
            out.println("<input type='hidden' name ='type' value='newtfill' />");
            out.println("<table>");
            for(i=0;i<3;i++)
            {
                 out.println("<tr>");
                  ...
                  else
                {
                   // s1[i][j]="<input type=text name='"+i+"' style='width:500px'></input>";
                    out.print("<td style=' width:500px'><input type=text name='"+i+"' style='width:500px;height:100%;padding:0px:margin:0px;text-align:center;font-family: algerian '></input></td>");
                }
